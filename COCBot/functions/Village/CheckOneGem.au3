...
Func OneGemBoost()
	...
	If $g_bFirstStart Or $initBoostTimeHeroes = "" Or $ChkIfBoostHero > 60 Or $HeroTime[$g_iCurAccount][0] <> "" Or $HeroTime[$g_iCurAccount][1] <> "" Or $HeroTime[$g_iCurAccount][2] <> "" Then
